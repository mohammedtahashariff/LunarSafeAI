...
export default function HUDOverlay({ phase, scrollProgress, mousePos, onLogoClick, missionOverride }: Props) {
  ...
  // Show hero text in deep_space
  useEffect(() => {
    if (phase === "deep_space") {
      const t = setTimeout(() => setShowHeroText(true), 800);
    ...
    >
      ...
      {showHero && showHeroText && (
        ...
        >
          ...
          >
            {phase === "deep_space" && scrollProgress < 0.03 && (
      ...
      {showFinalHero && (
        ...
        >
          <div className="flex flex-col items-center text-center gap-4">
            ...
            <button
              className="btn-mission mt-6 pointer-events-auto"
